...
public class CalendarModel {
    ...
    public CalendarModel(Calendar model) {
    }
    ...
    private ArrayList <Calendar> fechasList= new ArrayList();

    public ArrayList fechasMes (Calendar calendar){
        calendar = Calendar.getInstance();
        System.out.println("INSTANCIA DEL MODELO " + calendar);
        return fechasList;
    }
}
