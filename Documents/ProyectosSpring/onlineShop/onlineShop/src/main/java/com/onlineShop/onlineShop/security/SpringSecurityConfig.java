package com.onlineShop.onlineShop.security;
/*
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/", "/home", "/productspublic").permitAll()
 ...
 /*   @Autowired
    public void configureGlobal (AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                ...
                .and()
                .withUser("master").password("master").roles("MASTER");
    }
}*/
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/home", "/about", "/product").permitAll()
                .antMatchers("/admin/**").hasAnyRole("ADMIN")
                .antMatchers("/product/**").hasAnyRole("ADMIN")
                .antMatchers("/user/**").hasAnyRole("USER")
                //.antMatchers("/admin/**", "/product/**").hasAnyRole("MASTER")
                .anyRequest().authenticated()
                .and()
                .formLogin()
                .loginPage("/login")
